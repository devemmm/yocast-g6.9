    ...
    render() {
        ...
        <ScrollView style={{ marginTop: StatusBarHeight }}>
            ...
            <View style={{ paddingHorizontal: 15, paddingTop: H * .05, width: '80%' }}>
                <Text style={{ fontSize: 22, fontWeight: 'bold' }}>Create a new Password</Text>
                <Text style={{ fontSize: 13, color: _grey }}>Password should be different from the previous one</Text>
            </View>
            ...
            <View style={{ paddingHorizontal: 15, paddingTop: H * .05 }}>
                ...
                <TouchableOpacity style={{ backgroundColor: primary, height: 45, borderRadius: 5, alignItems: 'center', justifyContent: 'center' }}>
