...
import { bright, H, W, StatusBarHeight, _grey } from '../../screens/constants'
        ...
        style={{ flex: 1, marginTop: StatusBarHeight, backgroundColor: '#fff' }}>
            ...
            <View style={{ marginVertical: 10, marginHorizontal: 15 }}>
                ...
                <Text style={{ fontSize: 18,  fontWeight: 'bold', flex: 1 }}>Latest Release</Text>
                    ...
                    <TouchableOpacity 
                    onPress={() => this.props.navigation.navigate("SoundPlay", { item: this.state.LatestRelease[0] })} 
                    style={{ width: W - 30 , marginRight: 10 }}>
                        ...
                        <Text numberOfLines={3} style={{ paddingTop: 2,  fontWeight: 'bold', fontSize: 14, textTransform: 'capitalize' }}>{this.state.LatestRelease[0].name}</Text>
                        <Text style={{ color: 'grey', fontSize: 12, textTransform: 'capitalize' }}>{this.state.LatestRelease[0].ownerName}</Text>
                    </TouchableOpacity>
            </View> }
            ...
            <View style={{ marginVertical: 15 }}>
                ...
                <TouchableOpacity 
                onPress={() => this.props.navigation.navigate("CategoryPage")}
                style={{ padding: 5 }}>
            ...
            <View style={{ marginVertical: 10, marginHorizontal: 15 }}>
                ...
                <Text style={{ fontSize: 18,  fontWeight: 'bold', flex: 1 }}>Certified Platinum</Text>
                    ...
                    style={{ width: W - 30 , marginRight: 10, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text numberOfLines={3} style={{ paddingTop: 2,  fontWeight: 'bold', fontSize: 14, textTransform: 'capitalize' }}>{this.state.TopExpensive[0].name}</Text>
                        <Text style={{ color: 'grey', fontSize: 12, textTransform: 'capitalize' }}>{this.state.TopExpensive[0].ownerName}</Text>
                        </View>
                    </TouchableOpacity>
            </View> }
