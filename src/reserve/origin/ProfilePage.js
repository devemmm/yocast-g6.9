...
import { bright, H, StatusBarHeight, _grey } from './constants'
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1, marginTop: StatusBarHeight, backgroundColor: 'white' }}>
            ...
            <View style={{ paddingVertical: 10, paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={{ marginLeft: 20, flex: 1 }}>
                    <Text numberOfLines={1} style={{ fontSize: 16, marginBottom: 10, fontWeight: 'bold', textTransform: 'capitalize' }}>{this.state.username}</Text>
            ...
            <View style={{ paddingHorizontal: 15, paddingTop: 20 }}>
                ...
                <TouchableOpacity  onPress={() => this.props.navigation.navigate("Subscription")}  style={styles.profile_set}>
                ...
                <TouchableOpacity
                onPress={() => this.signout(this.state.token) } style={styles.profile_set}>
                    <Text style={styles.haeder}>Logout</Text>
                    <Text style={styles.det}>@{this.state.username}</Text>
                </TouchableOpacity>
...
<View style={{ height: H *.15 }}/>
            ...
            <View style={{ height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15 }}>
                <TouchableOpacity 
                onPress={() => this.setState({ terms: false })} 
                style={{ flex: .25, paddingVertical: 5, paddingRight: 10 }}>
                    <Image source={require('../../assets/arrow-left.png')} style={{ height: 28, width: 28 }} />
                </TouchableOpacity>
...
<View style={{ height: H *.15 }}/>
            ...
            <BottomSheet visible={this.state.edit}>
                <View style={{ flex: 1, backgroundColor: '#fff', paddingTop: Platform.OS === 'ios' ? StatusBarHeight : null }}>
                <ScrollView >
                    <View style={{ height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15 }}>
                        <TouchableOpacity onPress={() => this.setState({ edit: false })} style={{ flex: .25, paddingVertical: 5, paddingRight: 10 }}>
                            <Image source={require('../../assets/arrow-left.png')} style={{ height: 28, width: 28 }} />
                        </TouchableOpacity>
